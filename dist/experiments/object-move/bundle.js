...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _botcar = __webpack_require__(16);
...
/***/ (function(module, exports) {
	...
	var Car = function (_THREE$Object3D) {
	  ...
	  function Car(props) {
	    ...
	    var baseGeometry = new THREE.BoxGeometry(size, size / 2, size * 3);
	    ...
	    var arrowLength = size * 2;
	    var arrowColor = 0x00aaff;
	    ...
	    _this.moveSpeed = 50 * speedScale;
	    _this.rotationSpeed = Math.PI / 180 * 50 * speedScale;
	    return _this;
	  }
	  ...
	  _createClass(Car, [{
	    ...
	    value: function rotateLeft(delta) {
	      var rotationAngle = delta * this.rotationSpeed;
