...
function init() {
  ...
  const texture = new THREE.TextureLoader().load('../../assets/textures/slides/bheevik.jpg');
  const material = new THREE.MeshBasicMaterial({ map: texture });
  const texture1 = new THREE.TextureLoader().load('../../assets/textures/slides/diagram.png');
